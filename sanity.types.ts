...
// Query: *[  _type == "category"] | order(coalesce(title, name) asc) {  _id,  "title": coalesce(title, name),  "slug": slug.current,  "image": image{    asset->{      _id,      url    },    hotspot  },  "subcategories": *[_type == "subcategory" && references(^._id)] | order(name asc) {    _id,    name,    "slug": slug.current,    description  }}
...
// Query: *[  _type == "category"  && slug.current == $slug][0] {  _id,  "title": coalesce(title, name),  "slug": slug.current,  "image": image{    asset->{      _id,      url    },    hotspot  }}
...
// Query: *[  _type == "product"  && stock > 0  && featured == true] | order(name asc) [0...60] {  _id,  name,  "slug": slug.current,  description,  price,  "images": images[]{    _key,    asset->{      _id,      url    },    hotspot  },  category->{    _id,    title,    "slug": slug.current  },  stock}
...
// Query: *[  _type == "product"  && (slug.current == $slug || slug.current == "/" + $slug)][0] {  _id,  name,  "slug": slug.current,  description,  imageUrl,  imageUrls,  "image": image{    asset->{      _id,      url    },    hotspot  },  quantity,  molecularWeight,  purity,  storageBuffer,  storage,  certificateOfAnalysisUrl,  price,  "images": images[]{    _key,    asset->{      _id,      url    },    hotspot  },  category->{    _id,    title,    "slug": slug.current  },  material,  color,  dimensions,  stock,  featured,  assemblyRequired}
...
// Query: *[  _type == "product"  && ($categorySlug == "" || category->slug.current == $categorySlug)  && ($subcategorySlug == "" || subcategory->slug.current == $subcategorySlug)  && ($color == "" || color == $color)  && ($material == "" || material == $material)  && ($minPrice == 0 || price >= $minPrice)  && ($maxPrice == 0 || price <= $maxPrice)  && ($searchQuery == "" || name match $searchQuery + "*" || description match $searchQuery + "*")  && ($inStock == false || stock > 0)] | order(name asc) {  _id,  name,  "slug": slug.current,  description,  quantity,  price,  imageUrl,  imageUrls,  "image": image{    asset->{      _id,      url    }  },  "images": images[0...4]{    _key,    asset->{      _id,      url    }  },  category->{    _id,    title,    "slug": slug.current  },  subcategory->{    _id,    "slug": slug.current  },  material,  color,  stock}
...
// Query: *[  _type == "product"  && ($categorySlug == "" || category->slug.current == $categorySlug)  && ($subcategorySlug == "" || subcategory->slug.current == $subcategorySlug)  && ($color == "" || color == $color)  && ($material == "" || material == $material)  && ($minPrice == 0 || price >= $minPrice)  && ($maxPrice == 0 || price <= $maxPrice)  && ($searchQuery == "" || name match $searchQuery + "*" || description match $searchQuery + "*")  && ($inStock == false || stock > 0)] | order(price asc) {  _id,  name,  "slug": slug.current,  description,  quantity,  price,  imageUrl,  imageUrls,  "image": image{    asset->{      _id,      url    }  },  "images": images[0...4]{    _key,    asset->{      _id,      url    }  },  category->{    _id,    title,    "slug": slug.current  },  subcategory->{    _id,    "slug": slug.current  },  material,  color,  stock}
...
// Query: *[  _type == "product"  && ($categorySlug == "" || category->slug.current == $categorySlug)  && ($subcategorySlug == "" || subcategory->slug.current == $subcategorySlug)  && ($color == "" || color == $color)  && ($material == "" || material == $material)  && ($minPrice == 0 || price >= $minPrice)  && ($maxPrice == 0 || price <= $maxPrice)  && ($searchQuery == "" || name match $searchQuery + "*" || description match $searchQuery + "*")  && ($inStock == false || stock > 0)] | order(price desc) {  _id,  name,  "slug": slug.current,  description,  quantity,  price,  imageUrl,  imageUrls,  "image": image{    asset->{      _id,      url    }  },  "images": images[0...4]{    _key,    asset->{      _id,      url    }  },  category->{    _id,    title,    "slug": slug.current  },  subcategory->{    _id,    "slug": slug.current  },  material,  color,  stock}
...
// Query: *[  _type == "product"  && ($categorySlug == "" || category->slug.current == $categorySlug)  && ($subcategorySlug == "" || subcategory->slug.current == $subcategorySlug)  && ($color == "" || color == $color)  && ($material == "" || material == $material)  && ($minPrice == 0 || price >= $minPrice)  && ($maxPrice == 0 || price <= $maxPrice)  && ($searchQuery == "" || name match $searchQuery + "*" || description match $searchQuery + "*")  && ($inStock == false || stock > 0)] | score(  boost(name match $searchQuery + "*", 3),  boost(description match $searchQuery + "*", 1)) | order(_score desc, name asc) {  _id,  name,  "slug": slug.current,  description,  quantity,  price,  imageUrl,  imageUrls,  "image": image{    asset->{      _id,      url    }  },  "images": images[0...4]{    _key,    asset->{      _id,      url    }  },  category->{    _id,    title,    "slug": slug.current  },  subcategory->{    _id,    "slug": slug.current  },  material,  color,  stock}
