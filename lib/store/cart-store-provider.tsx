 ...
 */
export const useCartItem = (productId: string, size?: string) =>
  useCartStore((state) =>
    state.items.find(
      (item) =>
...
/**
 * Get total quantity in cart for a product across all sizes/lines
 */
export const useCartQuantityByProduct = (productId: string) =>
  useCartStore((state) =>
    state.items
